...
<div class="w3-row-padding w3-margin-bottom">
	...
	<div class="w3-quarter">
		<div class="w3-container w3-pink w3-padding-16">
			<div class="w3-left"><i class="fa fa-podcast w3-xxxlarge"></i></div>
			<div class="w3-right">
				<h3>{{duplicatedId}}</h3>
			</div>
			<div class="w3-clear"></div>
...
app.controller("myCtrl", function($scope) {
	...
	$scope.totalAvailableComputers = ${totalAvailableComputers};
	$scope.duplicatedId = ${duplicatedId};
