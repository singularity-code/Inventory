...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:200px;" id="mySidebar"><br>
	...
	<a href="./list_mac" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-desktop fa-fw"></i>Mac</a>
	...
	<div class="center">
		<div align="left" style="margin-bottom: 15px; margin-top: 25px;">
			<table>
				<tr>
					...
					<td><h3	>MAC : {{filtered.length}}</h3></td>
				</tr>
			</table>
		...
		<div id="toggleTarget" style="display: none;">
			...
			<form action="./create_koiMaterial" method="post" name="form">
				...
				<input class="simple-form" type="text" name="type" readonly="readonly" value="iMac">
...
app.controller("myCtrl", function($scope) {
	...
	$scope.nextId = function(type, user) {
		...
		if(type === 'staffDesktop') {
			if(length < 100) {
				return "HA-100" + nextNum;
			} else {
				return "HA-10" + nextNum;
			}
