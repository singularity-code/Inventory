...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:200px;" id="mySidebar"><br>
	...
	<a href="./list_telephone" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-fax fa-fw"></i>Telephone</a>
...
<div class="w3-main" style="margin-left:200px;margin-top:43px;">
	...
	<div class="center">
		<div align="left" style="margin-bottom: 15px; margin-top: 25px;">
			<table>
				<tr>
					<td><i class="fa fa-fax w3-xxlarge"></i></td>
					<td><h3	>TELEPHONE : {{filtered.length}}</h3></td>
				</tr>
			</table>
		...
		<div id="toggleTarget" style="display: none;">
			...
			<form action="./create_koiMaterial" method="post" name="form">
				...
				<input class="simple-form" type="text" name="type" readonly="readonly" value="Telephone">
...
app.controller("myCtrl", function($scope) {
	...
	$scope.nextId = function(type, user) {
		...
		if(type === 'staffDesktop') {
			if(length < 100) {
				return "ET-100" + nextNum;
			} else {
				return "ET-10" + nextNum;
			}
