...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:200px;" id="mySidebar"><br>
	...
	<a href="./list_laptop" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-laptop fa-fw"></i>Laptop</a>
	...
	<div class="center">
		...
		<div id="toggleTarget" style="display: none;">
			...
			<form action="./create_koiMaterial" method="post" name="form">
				...
				<input class="simple-form" type="text" name="type" readonly="readonly" value="Laptop">
		...
		<table id="mainTable" class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
			...
			<tr class={{obj.status}} id={{obj.id}} ng-repeat="obj in list | filter:$ctrl.query as filtered ">
				<td><i class="fa fa-laptop w3-large"></i></td>
				<td>{{obj.index}}</td>
				<td>{{obj.sn}}</td>
				<td>{{obj.id}}</td>
				<td>{{obj.type}}</td>
