...
public class AirConditioner extends KoiMaterial {

	public AirConditioner() {
		super();
	}

	public AirConditioner(String index, String sn, String id, String name, String type, String brand, String user,
