...
public class CashMachine extends KoiMaterial {

	public CashMachine() {
		super();
	}

	public CashMachine(String index, String id, String name, String type, String brand, String user, String previous,
