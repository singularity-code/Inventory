...
public class EFTPOSMachine extends KoiMaterial{

	public EFTPOSMachine() {
		super();
	}

	public EFTPOSMachine(String index, String id, String name, String type, String brand, String user, String previous,
